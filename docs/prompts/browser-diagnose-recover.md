...
type: "prompt"
title: "Diagnose and recover a failed browser session"
project: "kxm"
status: "accepted"
owner: "@operator"
created: "2026-09-14"
...
related: ["docs/guides/browser-automation.md", "docs/kb/how-to-recover-expired-session-or-orphan.md"]
---

# Task template: diagnose and recover a failed browser session

## Purpose

Use this prompt to troubleshoot unresponsive sessions, CDP attachment errors, authentication loops, or orphaned browser containers on your Steel deployment.
